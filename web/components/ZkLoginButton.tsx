...
export function ZkLoginButton() {
  ...
  if (session) {
    return (
      <div className="flex items-center gap-1 sm:gap-2">
        <span className="text-[10px] sm:text-xs text-gray-400 bg-gray-800 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg">
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 sm:gap-2 bg-white hover:bg-gray-100 text-gray-800 text-xs sm:text-sm font-medium px-2.5 sm:px-4 py-1 sm:py-1.5 rounded-lg transition-colors disabled:opacity-50"
    >
